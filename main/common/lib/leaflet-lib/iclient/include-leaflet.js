    ...
    function load() {
        ...
        if (!inArray(excludes, 'iclient9-leaflet')) {
            if (supportES6() && !inArray(includes, 'iclient9-plot-leaflet')) {
                inputScript("../../sui/leaflet/iclient9-leaflet-es6.js");
            } else {
                inputScript("../../sui/leaflet/iclient9-leaflet.js");
            }
        }
        if (inArray(includes, 'iclient9-leaflet-css')) {
            inputCSS("../../sui/leaflet/iclient9-leaflet.min.css");
        }
        ...
        if (inArray(includes, 'leaflet.miniMap')) {
            inputCSS("http://iclient.supermap.io/web/libs/leaflet/plugins/leaflet-miniMap/3.6.1/sui/Control.MiniMap.min.css");
            inputScript("http://iclient.supermap.io/web/libs/leaflet/plugins/leaflet-miniMap/3.6.1/sui/Control.MiniMap.min.js");
        }
