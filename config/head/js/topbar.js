require.config({
    ...
    paths:{
        "nav":'http://hnvmns-frontweb.frontconfig:8080/hnvmns-frontweb/basemanage/common/libs/nav/js/nav.min',
        "loginservice": "http://hnvmns-frontweb.frontconfig:8080/hnvmns-frontweb/basemanage/common/js/service/LoginController"
    }
})
define(["nav","loginservice"],function (nav,loginservice) {
    var topBar={};
    //logo图片路径
    topBar.imgSrc='http://hnvmns-frontweb.frontconfig:8080/hnvmns-frontweb/head/img/logo.png';
